...
weightsPath = os.path.sep.join([yolov4_path, "yolov4.weights"])
configPath = os.path.sep.join([yolov4_path, "cfg\\yolov4-original.cfg"])
...
frames_location = frames_locations[1]
