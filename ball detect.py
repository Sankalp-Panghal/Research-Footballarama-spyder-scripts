...
Run YOLO v3 for detection, and only mark rectangle around objects whose class name matches "ball"
...
frames_location = "D:\\Sequence Data Feb\\Seq 5 shelly 020\\3\\1080"
    ...
    if len(idxs) > 0:
        ...
        for i in idxs.flatten():
            ...
            if 'ball' in classes[classIDs[i]]:
                ...
                #.rectangle(image,( gr_x, gr_y), (gr_x + gr_w, gr_y + gr_h), (0,255,0), 2 )
                pred_xywh = (x,y,w,h)
